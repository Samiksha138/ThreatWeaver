...
NEVER suggest or create a "Products/", "products/", "Projects/", or any wrapper parent folder. The product folder is the FIRST level inside the workspace root.
...
**When asking the user for folder path, suggest this format:** `MyProduct/MyFeature/v1.0`
